...
# certifi is a python package which provides a set of root certificates . It is commonly used by python libraries that needs to make a secure http connection. CA is certificate authority. It is an entity that issues digital certificates to verify the identity of organizations and individuals on the internet.
